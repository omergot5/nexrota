...
// 06-03 — מחליף את WeekTimeGrid.jsx מבוסס-RBC). כל סימון חזותי של הדפוס
...
//   - אין כאן buildResourceRows ואין ייבוא מ-lib/resourceView.js: הפיבוט
//     קטגוריה×יום נשאר אצל הקורא, שמזין rows מוכן (D-02).
                      ...
                      <div className="space-y-1">
                        {day.items.map((item) => {
                          ...
                          const shortageBadge = short && (
                            ...
                            // רקע אדום בלי הרקע האטום הזה (זהה ל-EventContent
                            // ב-WeekTimeGrid.jsx).
                            <span
