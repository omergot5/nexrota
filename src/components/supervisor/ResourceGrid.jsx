...
//
// דפוס אחד, שני מסכים כיום: פאנל-תצוגה בתוך
// אשף בניית השבוע (RosterWizard, 06-02), ותצוגת שבוע ביומן (CalendarView,
// 06-03 — מחליף את הרכיב הישן מבוסס-הספרייה-החיצונית שקדם לו; מסך "מבט משאבים" הנפרד הוסר ב-Phase 10). כל סימון חזותי של הדפוס
