...
// לפי תחום.
// FOLDERS_BY_MODE/foldersFor/folderIcon/UNFILED/categoryOptions עברו ל-
// src/lib/categories.js (מודול טהור, בלי React) כדי ש-resourceView.js
// יוכל לצרוך אותם בלי לגרור JSX לתוך סקריפט node. views.jsx ממשיך
// לייבא מכאן ולא מגדיר את הטקסונומיה בשנית.
