...
const PATHS = {
  ...
  // הנגדה חזותית ל-clock: אותה גיאומטריה (מעגל + מחוגים), מעגל מכווץ כדי
  // לפנות מקום, מחוגים מקוצרים (קריא גם בגודל 12 שה-Badge מצייר), וקו
  // ביטול פינה-לפינה על תיבת המעגל — אותו סגנון ביטול ש-offline כבר קובע
  // בסט הזה. "יש שעון" מול "אין שעון" נקרא מזוג הגלפים בלבד, בלי מקרא.
  "clock-off": ["M12 8v4l2 1", { circle: [12, 12, 8] }, "m4 4 16 16"],
